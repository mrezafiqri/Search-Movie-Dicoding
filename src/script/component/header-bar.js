  ...
  render() {
    ...
    <header class="fixed bg-dark top-0 left-0 right-0 z-10 border-b-2 border-cyan-800">
      <nav class="flex relative justify-between items-center m-auto p-4 w-full md:w-11/12 md:px-0 lg:w-10/12">
        <a href="" class="text-slate-300 group duration-200 hover:text-cyan-600 cursor-pointer font-inter text-3xl font-[700] lg:text-4xl">NEM<span class="text-cyan-600 group-hover:text-slate-300 duration-200">TIX</span></a>
        ...
        <div id="search-container" class="nav-search absolute container m-auto flex justify-end pr-4 mt-4 z-10 gap-2 top-full right-0 md:pr-0 lg:w-1/2">
          <input type="search" placeholder="Search Movie..." id="searchElement" class="w-1/2 px-2 py-1 rounded-md text-slate-600 font-inter duration-200 md:p-2 focus:outline-none focus:ring-cyan-600 focus:ring-2 focus:border-cyan-600">
