  ...
  render() {
    ...
    <header class="fixed bg-dark top-0 left-0 right-0 z-10 border-b-2 border-cyan-800">
      <nav class="flex relative justify-between items-center m-auto p-4 w-full md:w-11/12 md:px-0 lg:w-10/12">
        <a href="" class="text-slate-300 group duration-200 hover:text-cyan-600 cursor-pointer font-inter text-3xl font-[700] lg:text-4xl 2xl:text-5xl">NEM<span class="text-cyan-600 group-hover:text-slate-300 duration-200">TIX</span></a>

        <a id="toggleSearchElement" href="#" class="flex justify-center items-center p-1 text-slate-300 hover:text-slate-500 duration-200">
          <svg role="img" class="fill-current  w-[28px] 2xl:w-[38px]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Search</title><path d="m13.716 17.261 6.873 6.582L24 20.282l-6.824-6.536a9.11 9.11 0 0 0 1.143-4.43c0-5.055-4.105-9.159-9.16-9.159S0 4.261 0 9.316c0 5.055 4.104 9.159 9.159 9.159a9.11 9.11 0 0 0 4.557-1.214ZM9.159 2.773a6.546 6.546 0 0 1 6.543 6.543 6.545 6.545 0 0 1-6.543 6.542 6.545 6.545 0 0 1-6.542-6.542 6.545 6.545 0 0 1 6.542-6.543ZM7.26 5.713a4.065 4.065 0 0 1 4.744.747 4.064 4.064 0 0 1 .707 4.749l1.157.611a5.376 5.376 0 0 0-.935-6.282 5.377 5.377 0 0 0-6.274-.987l.601 1.162Z"/></svg>
        </a>
        ...
        <div id="search-container" class="nav-search absolute container m-auto flex justify-end pr-4 mt-4 z-10 gap-2 top-full right-0 md:pr-0 lg:w-1/2">
          <input type="search" placeholder="Search Movie..." id="searchElement" class="w-1/2 px-2 py-1 rounded-md text-slate-600 font-inter duration-200 md:p-2 focus:outline-none focus:ring-cyan-600 focus:ring-2 focus:border-cyan-600 2xl:text-lg">
          <button class="text-slate-300 bg-dark px-4 py-2 rounded-md border-slate-500 border font-inter text-base font-[600] duration-200 hover:text-slate-100 hover:bg-primary lg:text-lg lg:px-6" id="btnSearchElement" type="submit">Search</button>
      </nav>
    </header>
    `;
