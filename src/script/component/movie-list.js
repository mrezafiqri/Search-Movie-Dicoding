...
class MovieList extends HTMLElement {
  ...
  render() {
    ...
    <div id="movieContainer" class="container mt-36 text-slate-200 grid grid-cols-2 gap-4 w-full m-auto px-4 relative md:w-11/12 md:px-0 md:grid-cols-3 lg:grid-cols-5 lg:w-10/12">
      ...
      <h1 id="title-movie" class="absolute cursor-default pb-1 -top-14 left-1/2 -translate-x-1/2 text-2xl font-inter capitalize font-[600] border-b-4 border-cyan-600 md:text-3xl">${valueSearchMovie.value || 'Popular Movies'}</h1>
